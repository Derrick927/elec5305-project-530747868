...
def main():
    clean_dir = Path("data16/train_clean")
    noisy_dir = Path("data16/train_noisy")
    noise_out_dir = Path("data16/noise")
    ...
    print(f"[Done] 已提取噪声，共 {len(clean_files)} 条 → 保存到 data16/noise")
